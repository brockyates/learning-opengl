...
namespace Graphics { namespace Utils {
    ...
    template <typename... Ts>
    void LOG_DEBUG(Ts... args)
    {
        ::Graphics::Utils::Log::GetLogger()->debug(args...);
    }

    template <typename... Ts>
    void LOG_CRITICAL(Ts... args)
    {
